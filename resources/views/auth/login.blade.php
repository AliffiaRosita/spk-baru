    ...
    <div class="login-clean" style="height:625px;background-color:rgba(241,247,252,0);">
        <form method="post" action="{{ route('login') }}" style="margin-top:35px;">
            ...
            <div class="form-group">
                <input  type="email" class="form-control" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus placeholder="Email" style="font-size:13px;">
            </div>
            <div class="form-group">
                <input  type="password" class="form-control" name="password" required autocomplete="current-password"placeholder="Password" style="font-size:13px;">
            </div>
