...
<form action="{{route('form.proses')}}" method="post" class="form-horizontal" enctype="multipart/form-data">
    @csrf
    <div class="row justify-content-center">
            ...
            <div class="card-body card-block">
                ...
                <div class="col-12 col-md-9">
                    <div class="custom-control custom-radio custom-control-inline">
                        ...
                        <label class="custom-control-label" for="{{$kriterias[$i]->namba_kriteria.$index}}">{{$kriterias[$i]->nama_kriteria}} &nbsp;</label>
