        ...
        <div class="card border border-secondary">
            ...
            <div class="card-body card-block">
                ...
                @if ($consistency_ratio <= 0.1) </div> </div> </div> </div> </div> </div> <div
                    ...
                    <div class="col-md-2">
                        <a href="{{route('form.alternatif',['id'=>$jenis+1])}}" class="btn btn-success"> <i class="fa fa-arrow-right"></i> Lanjutkan
                            Perhitungan</a>
                    </div>
                    ...
                    <div class="col" align="center">
                        <div class="alert alert-danger" role="alert">
                            <h6 class="alert-heading">Nilai Consistency Ratio (CR) Melebihi 0.1</h6>
                        </div>
                    </div>
            </div>
        </div>
...
<div class="row justify-content-center">
    <div class="col-md-2">
        <a href="{{route('form.alternatif',['id'=>$jenis])}}"
