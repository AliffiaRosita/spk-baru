            ...
            <div class="card-body card-block">
                <form action="{{route('criteria.store')}}" method="post" class="form-horizontal">
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-12 col-md-9"><input type="text" id="hf-email" name="nama_kriteria" placeholder="Nama Kriteria..." class="form-control" required="required"></div>
                    </div>
                    <div class="row form-group">
                        ...
                        <div class="col-12 col-md-9"><textarea name="Deskripsi" id="textarea-input" rows="7" placeholder="Deskripsi..." class="form-control" style="resize: none;" required="required"></textarea></div>
                    </div>
                </div>
