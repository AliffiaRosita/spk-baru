        ...
        <div class="card">
            ...
            <form action="{{route('kost.store')}}" method="post" class="form-horizontal" enctype="multipart/form-data">
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-12 col-md-9"><input type="text" id="hf-email" name="nama_kost" required="required" placeholder="Nama Kost..." class="form-control {{$errors->first('nama_kost') ? "is-invalid": ""}}">
                    ...
                    <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9"><textarea name="alamat" id="textarea-input" rows="3" required="required" style="resize: none;" placeholder="Alamat..." class="form-control {{$errors->first('alamat') ? "is-invalid": ""}}"></textarea>
                                <div class="invalid-feedback">
                                    {{$errors->first('alamat')}}
                                </div>
                            </div>
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-12 col-md-9"><input type="number" id="cost" name="harga" required="required" placeholder="Harga.." class="form-control {{$errors->first('harga') ? "is-invalid": ""}}">
                            <div class="invalid-feedback">
                                {{$errors->first('harga')}}
                            </div>
                        </div>
