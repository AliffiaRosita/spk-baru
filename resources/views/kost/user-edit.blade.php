    ...
    <div class="col-lg-10">
        <div class="card">
            ...
            <div class="card-body card-block">
                <form action="{{ route('user.kost.update', $kost->id) }}" method="post" class="form-horizontal"  enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="col">
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-12 col-md-9"><input type="text" id="hf-email" name="nama_kost" value="{{old('nama_kost') ?: $kost->nama_kost}}" placeholder="Nama Kost..." class="form-control {{$errors->first('nama_kost') ? "is-invalid": ""}}">
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-12 col-md-9"><textarea name="alamat" id="textarea-input" rows="3" style="resize: none;" placeholder="Alamat..." class="form-control {{$errors->first('alamat') ? "is-invalid": ""}}"> {{ old('alamat')?: $kost->alamat}}</textarea>
                            <div class="invalid-feedback">
                                    {{$errors->first('alamat')}}
                                </div>
                        </div>
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-12 col-md-9"><input type="number" id="cost" name="harga" placeholder="Harga.." value="{{ old('harga')?: $kost->harga}}" class="form-control {{$errors->first('harga') ? "is-invalid": ""}}">
                            <div class="invalid-feedback">
                                {{$errors->first('harga')}}
                            </div>
                        </div>
