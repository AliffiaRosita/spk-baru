        ...
        <div class="row justify-content-center">
            ...
            <div class="col" align="center">
                <div class="alert alert-danger" role="alert">
                    <h6>Nilai Consistency Ratio (CR) Melebihi 10%</h6>
                </div>
            </div>
        </div>
    </div>
...
<div class="row justify-content-center">
    <div class="col-md-2">
        <a href="{{route('user.form.kriteria')}}" class="btn btn-danger btn-lg"> <i class="fa fa-arrow-left"> </i> Kembali</a>
    </div>
</div>
</div>
...
<div class="row justify-content-center">
    ...
    <div class="col-md-2">
        <a href="{{route('user.form.alternatif',['id'=>0])}}" class="btn btn-success"> Lanjutkan Perhitungan <i class="fa fa-arrow-right"></i></a>
    </div>
